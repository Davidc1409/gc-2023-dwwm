<?php
    ...
    if (!isset($_POST["firstname"], $_POST["lastname"], $_POST["username"], $_POST["email"], $_POST["pwd"])) {
    ...
    $query = $db->prepare("INSERT INTO users (firstname,lastname,username,email,pwd) Values (:firstname,:lastname,:username,:email,:pwd)");
